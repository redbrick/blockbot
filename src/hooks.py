...
def restrict_to_roles(role_ids: typing.Sequence[hikari.Snowflake]) -> typing.Callable[[arc.GatewayContext], typing.Awaitable[arc.HookResult]]:
...
def restrict_to_channels(channel_ids: typing.Sequence[hikari.Snowflake]) -> typing.Callable[[arc.GatewayContext], typing.Awaitable[arc.HookResult]]:
    async def func(ctx: arc.GatewayContext) -> arc.HookResult:
